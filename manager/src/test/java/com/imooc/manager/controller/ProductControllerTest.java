...
@FixMethodOrder(MethodSorters.NAME_ASCENDING) //测试用例按照方法字典顺序执行
public class ProductControllerTest {

    private static RestTemplate rest = new RestTemplate(); //使java访问url更方便，更优雅
